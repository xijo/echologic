module StatementHelper
  ...
  def create_question_link_for(category)
    link_to(I18n.t("discuss.statement.create_a_new", :type => Question.display_name), new_question_url(:category => category.value), :class=>'create_statement_button create_question_button') if current_user.has_role?(:editor)
  end
